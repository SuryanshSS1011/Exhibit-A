...
export const prosecutorExample: Case = {
  ...
  truth: {
    ...
    execution_reason: "completed 5 target execution(s)",
    goal_reason: "deterministic fail-on-target and pass-on-base flip",
    release_reason: "release safety was not assessed",
  },
  verdict: "VERIFIED",
